...
export function PatientUpdatePage (patient) {
  ...
  const updatePatient=(patient_cred)=>{
    patient_cred["patient_id"]=patient["patient_id"]
    console.log(patient_cred,JSON.stringify( patient_cred ))
    var requestOptions = {
        method: 'POST',
        headers: myHeaders,
        mode: 'cors',
        redirect: 'follow',
        body: JSON.stringify( patient_cred )  
      };

      fetch("http://localhost:3000/updatePatient", requestOptions)
    ...
    const handleSubmit = (event) => {
        ...
        for (const defaultValue of data.entries()) {
            patient_cred[defaultValue[0]]=defaultValue[1]
          console.log("now: ",defaultValue);
        }
        updatePatient(patient_cred)
    ...
    <p class="mt-1 block font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
      Edit Patient details. {patient["age"]}
    </p>
    <form onSubmit={handleSubmit} class="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
      <div class="mb-4 flex flex-col gap-6">
        ...
        <div class="relative h-11 w-full min-w-[200px]">
          <input
            class="peer h-full w-full rounded-md border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
            defaultValue={patient["occupation_class"]}
        ...
        <div class="relative h-11 w-full min-w-[200px]">
          <input
            class="peer h-full w-full rounded-md border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
            defaultValue={patient["eligibility_status"]}
